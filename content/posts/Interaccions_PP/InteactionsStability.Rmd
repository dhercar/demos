...
When calcualting the stability proportion for different combinations of interaction strengths and connectances we obtain the following result: 
...
grid.arrange(
  ...
  stat_summary_hex(bins=10,col="white", size=0.5)+ 
    scale_fill_gradient2(name= "Stability",
                         low="coral4",
                         mid="wheat2",
                         high="deepskyblue4", 
                         midpoint = 0.5)+ 
