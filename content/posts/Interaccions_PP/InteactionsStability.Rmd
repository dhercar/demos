...
ggplot(stability.data, aes(y=as.numeric(stability), x=int)) + geom_jitter(width=0.5, height = 0.02,size=3, alpha=0.1)+ 
    geom_smooth(method="glm",method.args=list(family=binomial), colour="coral", se=F )+ ylab("Stability")+ xlab("Interactions/Species")+theme(legend.position="") 
```
